...
<div id="loan-request-wrapper">
    ...
    <div id="loan-request-header">
        <img src="presentation/images/loan-request-header1.jpg">
    ...
    <div id="loan-request-form-wrapper">
        ...
        <form action="get-customer-info">
            <input type="text" name="national-code" required placeholder="کد ملی" maxlength="10"
                   oninvalid="showNullAlert(this);" oninput="this.setCustomValidity('');"
                   value='<%= (request.getParameter("national-code") == null)? "" : request.getParameter("national-code") %>'>
