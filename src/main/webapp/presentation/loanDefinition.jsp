...
<div id="loan-box-wrapper">
    ...
    <div id="loan-definition-content-wrapper">
        ...
        <form action="../get-submitted-conditions">
            <input type="text" name="loan-name" placeholder="نام تسهیلات" required maxlength="25" oninvalid="showNullAlert(this)" oninput="this.setCustomValidity('');">
            <input type="text" name="loan-interest-rate" pattern="^(0)?[0-9]([0-9])?( )?(%)?$|^100( )?(%)?$" placeholder="نرخ سود به درصد" required maxlength="5" oninvalid="showWrongPercentageAlert(this)" oninput="this.setCustomValidity('');" >
